...
<style>
    ...
    .block-container {
        ...
        padding: 1.5rem 2rem !important; /* Padding diperkecil */
        max-width: 450px !important; 
        margin: 3vh auto !important; /* Margin atas diperkecil dari 6vh ke 3vh */
    ...
    .logo-wrapper {
        ...
        align-items: center;
        margin-bottom: 10px; /* Spasi diperkecil */
        width: 100%;
        filter: drop-shadow(0 4px 8px rgba(0,0,0,0.3)); /* Shadow halus pada gambar saja */
    }
    .logo-wrapper img {
        max-width: 160px; /* Ukuran disesuaikan */
        height: auto;
    }
    ...
    /* Tipografi Judul - Spasi Diperketat */
    .app-title {
        text-align: center;
        color: white;
        font-size: 1.6rem;
    ...
    .app-subtitle {
        ...
        color: #a7f3d0;
        font-size: 0.85rem;
        margin-bottom: 20px; /* Spasi diperkecil */
    }
    ...
    .stTextInput p {
        ...
        margin-bottom: 2px !important; /* Jarak label ke kotak dipersempit */
    }
    .stTextInput > div > div > input {
        background-color: #f1f5f9 !important; 
        color: #0f172a !important; 
        border-radius: 8px !important;
        padding: 10px 15px !important; /* Kotak input lebih tipis */
    ...
    .divider {
        ...
        color: #e2e8f0; font-size: 0.75rem; margin: 15px 0 10px 0;
    }
...
def tampilkan_login():
    ...
    with st.form("login_form"):
        ...
        email_input = st.text_input("EMAIL", placeholder="admin@raziq.com")
        password_input = st.text_input("PASSWORD", type="password", placeholder="••••••••")
        
        submit_btn = st.form_submit_button(":material/login: Masuk")
        
        if submit_btn:
            if email_input == "admin@raziq.com" and password_input == "admin123":
