    ...
    with t3:
        ...
        if semua_barang:
            with st.form("form_penyesuaian"):
                ...
                c1, c2 = st.columns(2)
                stok_fisik_asli = c1.number_input("Jumlah Fisik Sebenarnya di Gudang", min_value=0.0, step=0.5, value=float(pilihan_barang.stok_saat_ini))
