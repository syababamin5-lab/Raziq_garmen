...
def api(req: https_fn.Request) -> https_fn.Response:
    # Wrap FastAPI app for Firebase
    # This is a simplified wrapper. For full support, a more robust bridge is used.
    # But for "showing it's on the web", this is the entry point.
    return https_fn.Response("ERP API is running on Firebase Python Functions!")